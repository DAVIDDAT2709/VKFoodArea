This package provides .NET for Android and MAUI bindings for the Java library `androidx.camera:camera-lifecycle`.
...
| **Project URL** | https://developer.android.com/jetpack/androidx/releases/camera#1.4.2 |
