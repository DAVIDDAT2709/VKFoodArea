...
public static class SeedData
{
    ...
    private static async Task EnsureSeedPoisAsync(AppDbContext db)
    {
        var existingPois = await db.Pois.ToListAsync();
        var existingByQr = existingPois
            .Where(x => !string.IsNullOrWhiteSpace(x.QrCode))
            .GroupBy(x => NormalizeQr(x.QrCode))
            .ToDictionary(x => x.Key, x => x.First());

        foreach (var seedPoi in GetSeedPois())
        {
            var normalizedQr = NormalizeQr(seedPoi.QrCode);

            if (!existingByQr.TryGetValue(normalizedQr, out var existing))
            {
                db.Pois.Add(seedPoi);
                existingByQr[normalizedQr] = seedPoi;
                continue;
            }

            existing.Name = seedPoi.Name;
            existing.Address = seedPoi.Address;
            existing.PhoneNumber = seedPoi.PhoneNumber;
            existing.Latitude = seedPoi.Latitude;
            existing.Longitude = seedPoi.Longitude;
            existing.RadiusMeters = seedPoi.RadiusMeters;
            existing.Priority = seedPoi.Priority;
            existing.Description = seedPoi.Description;
            existing.TtsScriptVi = seedPoi.TtsScriptVi;
            existing.TtsScriptEn = seedPoi.TtsScriptEn;
            existing.TtsScriptZh = seedPoi.TtsScriptZh;
            existing.TtsScriptJa = seedPoi.TtsScriptJa;
            existing.TtsScriptDe = seedPoi.TtsScriptDe;
            existing.MapUrl = seedPoi.MapUrl;
            existing.IsActive = true;
            existing.ImageUrl = seedPoi.ImageUrl;
            existing.QrCode = seedPoi.QrCode;
        }
    }
    ...
    private static IReadOnlyList<Poi> GetSeedPois()
    {
        return
        [
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7607194,106.7032972",
                IsActive = true,
            ...
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7614025,106.7027047",
                IsActive = true,
                ImageUrl = "ocvu.png",
                QrCode = "poi:oc-vu"
            },
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7616799,106.7023636",
                IsActive = true,
                ImageUrl = "octhao.jpg",
                QrCode = "poi:oc-thao"
            },
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7611663,106.7057009",
                IsActive = true,
                ImageUrl = "otxiem.jpg",
            ...
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7605012,106.7041323",
                IsActive = true,
            ...
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7612809,106.7059746",
                IsActive = true,
                ImageUrl = "ocnhi.jpg",
                QrCode = "poi:oc-nhi"
            },
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7612240,106.7026292",
                IsActive = true,
                ImageUrl = "ocloan.jpg",
                QrCode = "poi:oc-loan"
            },
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7605965,106.7039361",
                IsActive = true,
                ImageUrl = "ocbui.jpg",
                QrCode = "poi:oc-bui"
            },
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7607246,106.7069244",
                IsActive = true,
                ImageUrl = "octy.jpg",
                QrCode = "poi:oc-ty"
            },
            new Poi
            {
                ...
                MapUrl = "https://maps.google.com/?q=10.7607418,106.7036081",
                IsActive = true,
